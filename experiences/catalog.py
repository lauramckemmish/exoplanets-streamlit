...
def experience_catalog(facilitated_pathway, stage4_pathway, stage5_pathway):
    return [
        ...
        ("Find Tatooine", "A guided data-science mission: turn clues from Star Wars into testable criteria, inspect candidate worlds and communicate uncertainty in your conclusion."),
    ]
