...
A Streamlit collection of four astronomy and data-science learning experiences using real NASA Exoplanet Archive data, plus an Explore resource.

## Experiences

- **Planet Shopping Outside Our Solar System** — a facilitated filtering, missing-data and evidence-based decision experience.
...
- **Exoplanet Data Lab** — explore variables, data representations and patterns.
