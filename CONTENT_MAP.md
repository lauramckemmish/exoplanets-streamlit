...
Each experience has its own module in `experiences/`. Student-facing wording, lesson order and pathway-specific Facilitator notes content belong with that experience.
...
| **Strange New Worlds** (Year 8) | `experiences/strange_new_worlds.py` | Year 8 student steps, Facilitator notes and background information. |
...
- `experiences/classroom_shell.py` — top step tabs, Facilitator-notes placement and Back/Continue controls.
...
Do not edit these files to change a lesson’s student-facing text or Facilitator notes. Edit the relevant Year 8 or Year 10 module instead.
...
Then open the edited experience in Streamlit and check the relevant page, Facilitator notes and any linked chart or reveal.
